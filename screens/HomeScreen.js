...
*/} 
          ...
          <View style={{ padding: 10 }}>
{/**             <Button style={styles.ButtonCss} title="Global Information" onPress={()=> {navigation.navigate('Dashboard',{id: 12, name: "Talha"})}}/> */}
            <TouchableOpacity activeOpacity={0.5} onPress={()=> {navigation.navigate('Dashboard',{id: 12, name: "Talha"})}}>
            <View style={styles.ButtonCss}>
